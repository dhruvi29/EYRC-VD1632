...
class edrone():
    ...
    def __init__(self):
        ...
        self.goal_point = [18.9999999966,72.0000000083,13.44099755545]
        #initialising current points
        self.curr_point = [18.9999999966,72.0000000083,8.44099755545]
        self.set_point = [18.9999999966,72.0000000083,13.44099755545]
    ...
    def path_plan_comp(self):
        ...
        if abs(self.goal_point[0]-self.curr_point[0])<0.000000500 and abs(self.goal_point[1]-self.curr_point[1])<0.000000500:
            return True
        return False
    ...
    def handler_2(self):
        ...
        if self.TAKEOFF:
            ...
            self.distance()
            self.path_plan()
            if self.path_plan_comp() and self.isDetected:
