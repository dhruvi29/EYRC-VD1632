...
class detect():
	...
	def __init__(self):
		...
		self.marker_pub = rospy.Publisher("/marker_data", MarkerData, queue_size =1)
		self.detect_pub = rospy.Publisher('/detection',Bool,queue_size=1)
		self.img = empty([]) 
		...
		rospy.Subscriber('/marker_id', Int8, self.marker_id)
	...
	def image_callback(self, data):
		...
		try :
			...
			self.marker_pub.publish(self.markerdata)
		except Exception as e :
			print(e)
