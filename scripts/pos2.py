...
class edrone():
    ...
    def __init__(self,set_point):
        ...
        # self.Kp = [5000*100,1500*100, 5000*0.2]
...
if __name__ == '__main__':
    ...
    e_drone_1 = edrone([19.0009248718,71.9998318945, 25.16])
    e_drone_2 = edrone([19.0007046575,71.9998955286, 25.16])
    e_drone_3 = edrone([19.0007046575,71.9998955286, 22.1599967919])
    ...
    while not rospy.is_shutdown():
        ...
        if flag[0]==0:
            ...
            e_drone_2.pid()
            if abs(e_drone_2.error[0])<=0.000001517 and abs(e_drone_2.error[1])<=0.000001517:
                i2+=1
                if i2==10:
                    flag[1]=1
