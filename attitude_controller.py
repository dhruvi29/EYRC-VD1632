...
class Edrone():
	...
	def __init__(self):
		...
		# self.Kp = [2052*0.06, 1266*0.06, 0*0.06]
		# self.Ki = [0*0.008, 4*0.008, 0*0.008]
		# self.Kd = [566*0.3, 240*0.3, 0*0.3]
		self.Kp = [0, 0, 0]
		self.Ki = [0, 0, 0]
		self.Kd = [0, 0, 0]
	...
	# Hint : Add variables for storing previous errors in each axis, like self.prev_values = [0,0,0] where corresponds to [roll, pitch, yaw]
		...
		self.zero_error_pub = rospy.Subscriber('/zero_error', Float32, queue_size=1)
